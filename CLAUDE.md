...
- **Consenso continuo al posto del modulo.** Il consenso vive nell'interazione, nell'ascolto e nei gesti, si conferma momento per momento e resta sempre revocabile. Niente moduli di consenso scritto per singole manualità. Solo su accordo trasparente fra le parti è possibile una traccia condivisa (per esempio una registrazione audio), riferita a qualsiasi trattamento e mai a "zone intime". Pagina di riferimento: `/consenso`.
