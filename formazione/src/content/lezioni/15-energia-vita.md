...
slug: energia-vita
titolo: "Energia generativa e vita fisiologica"
sommario: "L'energia generativa viene riconosciuta e sublimata; il livello vitale riporta a respiro, battito e radicamento."
tipo: studio
durataMinuti: 9
ordine: 3
obiettivi: ["comprendere la sublimazione", "riconoscere il fondo fisiologico della presenza", "distinguere energia e azione nell'esperienza"]
domande: ["Come distingui energia e azione?", "Quale esperienza semplice ti riporta al fatto di essere presente?", "Dove incontri, nella tua vita, un'energia che diventa creazione?"]
fonti:
  - { titolo: "Sessualità, tantra e confini", url: "https://www.tao-veda.org/confini" }
  - { titolo: "Kundalini, chakra e la via del Drago", url: "https://www.tao-veda.org/conoscenza/tradizioni/kundalini" }
  - { titolo: "I quattro livelli del rilassamento profondo", url: "https://www.tao-veda.org/quattro-livelli" }
---
Il terzo livello è il più delicato da raccontare, e per questo chiede le parole più precise. La cultura in cui viviamo conosce due modi di parlare dell'energia sessuale: il silenzio del privato e il rumore del consumo. Le tradizioni contemplative conoscono un terzo modo, più antico di entrambi, e questa lezione lo consegna con la calma che merita.
...
I due livelli di questa lezione si possono immaginare come movimento e fondamento: l'energia che sale e la base che sostiene. Nella mappa simbolica del metodo la vitalità può essere immaginata come risalita lungo l'asse del corpo, dal radicamento verso percezioni più sottili: è l'immagine che kundalini e via del Drago raccontano ciascuna a suo modo. Resta un linguaggio, e il suo compito è quello di sempre: dare forma a ciò che può essere esperito, e lasciare all'esperienza l'ultima parola.

## Nel diario

Annota dove incontri, nella tua vita, la differenza fra un'energia che si scarica e un'energia che diventa presenza o creazione: una giornata di slancio spesa bene, un impulso trasformato in progetto, una vitalità che ha trovato forma. E annota anche un momento di fondo semplice: dove eri, che cosa lo ha reso percepibile.
